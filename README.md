...
| [dev-tools](./plugins/dev-tools) | 2.6.0 | 发布、任务管理、联网与效率审计 | github-repo-publish, efficiency-audit, todo, web-search, animate-prompt, web-connect, remote-dev-sync, ssh-connect |
