...
| 独立 App 建立与发布 | 从 0 到 1 建独立 App：工程边界、preview/production 语义、runtimeVersion 命名、复用自托管 OTA、release-doctor 与验证 gate | [app-build-and-release.md](app-build-and-release.md) | 2026-07-12 |
